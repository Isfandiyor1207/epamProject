...
public final class ValidationParameterName {
    ...
    public static final String WRONG_EMAIL="email_error";
    public static final String WRONG_PHONE_NUMBER="phone_number_error";
    public static final String WRONG_PASSWORD="password_error";
    public static final String WRONG_PSW_REPEATED="psw_repeated_error";
    public static final String WRONG_USERNAME="username_error";

                    ...
                    <tr>
                        ...
                        <td style="text-transform: none">
                            <form>
                                ...
                                <button class="btn btn-outline-warning" name="genre" value="${item}">
                                    <a href="${pageContext.request.contextPath}/pages/admin/genre_update.jsp"><fmt:message key="label.update_btn"/></a></button>
                            </form>
                        </td>
                    </tr>
                </c:forEach>
